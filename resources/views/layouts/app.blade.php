...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <nav
            id="main-navbar"
            class="navbar navbar-expand-md navbar-dark bg-dark py-0"
        >
            <div class="container">
                <a class="navbar-brand" href="{{ route('home') }}">
                    <span class="d-none">ILKOOM</span>
                    <img
                        src="{{ asset('img/ilkoom_logo.png') }}"
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link p-4" href="{{ route('login') }}"
                                >Login</a
                            >
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a
                                id="navbarDropdown"
                                class="nav-link dropdown-toggle p-4"
                                href="#"
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a
                                    class="dropdown-item p-4 py-md-2"
                                    href="{{ route('logout') }}"
...
document.getElementById('logout-form').submit();"
                        ...
                        Case Study: ILKOOM Profile Manager @endguest
                    </ul>
                </div>
            </div>
        </nav>
                ...
                <div class="row">
                    <div class="col-md-3 text-center text-md-start">
                        ...
                        <p>
                            ...
                            elit. Aperiam cumque, esse modi maxime veniam nulla
                            delectus dolorem
                        </p>
                    </div>
                    ...
                    <div class="col-md-3 text-center text-md-start">
                        ...
                        <div class="text-nowrap">
                            <i class="fas fa-phone fa-fw me-3"></i> (021) 123456
                        </div>
                        <div class="text-nowrap">
